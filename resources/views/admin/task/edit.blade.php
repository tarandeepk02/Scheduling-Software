...
<div class="page-wrapper">
  ...
  <div class="container-fluid">
    <form class="form-horizontal" action="{{route('admin.task.update', $task->task_id )}}" method="POST" enctype="multipart/form-data" role="form">
      {{csrf_field()}}
          ...
          <div class="card">
              ...
              <div class="row m-t-10">
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <select class="form-control multiselect-single" id="client" name="client_id">
                      ...
                      <option value="{{ $client->client_id }}" @if($task->client_id==$client->client_id) selected="selected" @endif>{{ $client->first_name.' '.$client->last_name }}</option>
                ...
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputEmail3" name="title" value="{{ $task->title }}" placeholder="Job Title">
                ...
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="inputEmail3" name="instructions" placeholder="Instructions">{{ $task->instructions }}</textarea>
                ...
                <div class="col-6">
                  <div class="form-group">
					...
					@php $se_employees = explode(',',$task->employees); @endphp
                ...
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <select class="form-control" id="status" name="status">
                      <option value="Designing" @if($task->status=='Designing') selected="selected" @endif>Designing</option>
                      <option value="Approval" @if($task->status=='Approval') selected="selected" @endif>Approval</option>
                      <option value="Production" @if($task->status=='Production') selected="selected" @endif>Production</option>
                      <option value="Installation" @if($task->status=='Installation') selected="selected" @endif>Installation</option>
                    </select>
            ...
            <div class="card-body">
              <div class="form-group m-b-0 text-right">
                <button type="submit" class="btn btn-info waves-effect waves-light">Save Task</button>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="row m-t-20" id="datetimePicker">
                <div class="col-12">
                  <div class="form-group has-feedback">
                    ...
                    <div class="input-group">
                      <input type="text" class="date start form-control" placeholder="Start Date" name="start_date" value="{{ $task->start_date }}" autocomplete="off"/>
                      <input type="text" class="time start form-control last-input" placeholder="Start Time" name="start_time" value="{{ $task->start_time }}" autocomplete="off"/>
                ...
                <div class="col-12">
                  <div class="form-group has-feedback">
                    ...
                    <div class="input-group">
                      <input type="text" class="date end form-control" placeholder="End Date" name="end_date" value="{{ $task->end_date }}" autocomplete="off"/>
                      <input type="text" class="time end form-control last-input" placeholder="End Time" name="end_time" value="{{ $task->end_time }}" autocomplete="off"/>
