...
<div class="page-wrapper">
  ...
  <div class="container-fluid">
    <form class="form-horizontal r-separator" action="{{route('admin.task.store')}}" method="POST" enctype="multipart/form-data" role="form">
      {{csrf_field()}}
      <div class="row">
        <div class="col-8">
          <div class="card">
                ...
                <div class="col-12">
                  <div class="form-group has-feedback">
                    ...
                    <div class="input-group">
                      <input type="text" class="date start form-control" placeholder="Start Date" name="start_date" value="{{ old('start_date') }}" autocomplete="off"/>
                      <input type="text" class="time start form-control last-input" placeholder="Start Time" name="start_time" value="{{ old('start_time') }}" autocomplete="off"/>
                       @if ($errors->has('start_date')) <span class="help-block"> <strong>{{ $errors->first('start_date') }}</strong> </span> @endif
					    @if ($errors->has('start_time')) <span class="help-block"> <strong>{{ $errors->first('start_time') }}</strong> </span> @endif
						 </div>
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-group has-feedback">
                    ...
                    <div class="input-group">
                      <input type="text" class="date end form-control" placeholder="End Date" name="end_date" value="{{ old('end_date') }}" autocomplete="off"/>
                      <input type="text" class="time end form-control last-input" placeholder="End Time" name="end_time" value="{{ old('end_time') }}" autocomplete="off"/>
                      @if ($errors->has('end_date')) <span class="help-block"> <strong>{{ $errors->first('end_date') }}</strong> </span> @endif
					    @if ($errors->has('end_time')) <span class="help-block"> <strong>{{ $errors->first('end_time') }}</strong> </span> @endif
